...
##Adaptions to make it run for 2d lat/lon 
...
def main(argv):
    ...
    parser.add_argument('--oformat'  , help='Output data format [SCRIP, ESMF], defaults to ESMF', required=False, type=file_type, nargs='?', const='scrip')
