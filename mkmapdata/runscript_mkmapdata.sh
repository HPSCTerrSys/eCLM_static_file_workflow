...
export GRIDNAME=EUR-0275
export CDATE=`date +%y%m%d`
export GRIDFILE=SCRIP_EUR-0275.nc


### Path to the raw files downloaded for the clm website
rawpath="/p/scratch/cjibg31/jibg3105/Data/CLM5EU3/code_clm5eu3/eu_11_eclm_curvilinear/mkmapdata/"
outpath="/p/scratch/cjibg31/jibg3105/Data/CLM5EU3/code_clm5eu3/eu_11_eclm_curvilinear/mkmapdata/"



#SCRIPgrid_0.5x0.5_AVHRR_c110228.nc SCRIPgrid_0.25x0.25_MODIS_c170321.nc SCRIPgrid_3minx3min_LandScan2004_c120517.nc SCRIPgrid_3minx3min_MODISv2_c190503.nc SCRIPgrid_3minx3min_MODISwcspsea_c151020.nc SCRIPgrid_3x3_USGS_c120912.nc SCRIPgrid_5x5min_nomask_c110530.nc SCRIPgrid_5x5min_IGBP-GSDP_c110228.nc SCRIPgrid_5x5min_ISRIC-WISE_c111114.nc SCRIPgrid_5x5min_ORNL-Soil_c170630.nc SCRIPgrid_10x10min_nomask_c110228.nc SCRIPgrid_10x10min_IGBPmergeICESatGIS_c110818.nc SCRIPgrid_3minx3min_GLOBE-Gardner_c120922.nc SCRIPgrid_3minx3min_GLOBE-Gardner-mergeGIS_c120922.nc SCRIPgrid_0.9x1.25_GRDC_c130307.nc SCRIPgrid_360x720_cruncep_c120830.nc UGRID_1km-merge-10min_HYDRO1K-merge-nomask_c130402.nc
for file in ${rawpath}SCRIPgrid_*.nc; ${rawpath}UGRID_*.nc; do
    OUTFILE=map_${file}_to_${GRIDNAME}_nomask_aave_da_c$CDATE.nc
    srun $ESMFBIN_PATH/./ESMF_RegridWeightGen --ignore_unmapped -s ${rawpath}${file} -d  $GRIDFILE -m conserve -w ${outpath}${OUTFILE} --dst_regional --netcdf4
